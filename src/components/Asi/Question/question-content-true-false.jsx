...
const QuestionContent = ({ theme }) => {
  ...
  const answerQuestion = (e) =>{
    e.preventDefault();
    const next_question = "/question/open";
    const in_value = document.querySelector('input[name=answer_question]:checked');
    const txt_success   = t('questions.true_false.txt_success');
    const txt_error     = t('questions.true_false.txt_error');
                    ...
                    <div className="row">
                      <div className="col-12 mb-3">
                        <p className="fs-16 txt-color-black">
                          {t('questions.true_false.instruction')}
                        </p>
                      </div>
                        ...
                        <div className="answer wow fadeIn" data-wow-delay="0.5s">
                          <div className="form-check form-check-inline">
                            ...
                            <label className="form-check-label" htmlFor="ans_opt_1">
                              {t('questions.true_false.answer_yes')}
                            </label>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="answer wow fadeIn" data-wow-delay="0.75s">
                          <div className="form-check form-check-inline">
                            ...
                            <label className="form-check-label" htmlFor="ans_opt_2">
                              {t('questions.true_false.answer_no')}
                            </label>
                          </div>
                        </div>
                      </div>
