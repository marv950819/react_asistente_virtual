...
const QuestionContent = ({ theme }) => {
  ...
  const answerQuestion = (e) =>{
    ...
    const next_question = "/question/multiple";
    const txt_success   = t('questions.open.txt_success');
    const txt_error     = t('questions.open.txt_error');
                  ...
                  <div className="col-12">
                    <div className="full-width">
                      <div className="img sizxl skills-circle card-question w-100 mb-30 wow fadeIn" data-wow-delay=".6">
                        <img src="/img/asi/uns/20_sm.jpg" className="img-fluid" alt=""/>
                        <div className="p-2">
                          <h6 className="txt-color-blue fs-16 fs-question mt-20 mb-20 text-center">
                            {t('questions.open.title')}
                          </h6>
                        </div>
                      </div>
                    </div>
                            ...
                            <form className="mt-5">
                              <div className="form-group">
                                <label htmlFor="answer_question">
                                  {t('questions.open.answer')}
                                </label>
                                <textarea className="form-control" id="answer_question" rows="3"></textarea>
                              </div>
                            </form>
                          </div>
                        </div>
